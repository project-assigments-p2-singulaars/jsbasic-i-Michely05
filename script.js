...
let arrayExample = ["item1", "item2", "item3", "item4", "item5"];
...
let primeraComparacion = i === j;

console.log(primeraComparacion);
...
let segundaComparacion = k === l;

console.log(segundaComparacion);
...
console.log(result); //Realiza la operación de comparación que consideres entre las dos variables dadas, para que el resultado en consola sea false sin usar el comparador de desigualdad
